# Weekly Digest (Monorepo)

This repository contains both the static frontend and the Flask backend used to generate the weekly WDWDLW report (Meeting Notes + GitHub Commits + Trello Actions).
...
├── index.html           # Single-page Weekly Digest (repo root)
├── scripts/
│   └── trello_activity.py
